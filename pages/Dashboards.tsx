...
const Dashboards: React.FC<DashboardsProps> = ({ onNavigate }) => {
  ...
  const dashboardList = [
    ...
    },
    {
      ...
      desc: "Een helikopterview voor de directie, van EBITDA tot marktpenetratie en strategische mijlpalen.",
        ...
        <div className="container mx-auto px-8">
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
              ...
              <div className="flex gap-6 items-start">
                 ...
                 <div>
                    <h4 className="font-bold text-white uppercase tracking-widest text-sm mb-2">Secure Cloud</h4>
                    <p className="text-xs text-slate-500 font-light">Gefaciliteerd via Enterprise Azure beveiliging.</p>
                 </div>
              </div>
           </div>
        </div>
